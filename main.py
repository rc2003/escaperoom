    ...
    def interact(self, item=None):
        if self.interactions:
            ...
            if action is not None:
                ...
                if "remove_hunger" in action:
                    self.game.counter-=self.game.counter/2
...
class Game:
    ...
    def update(self):
        ...
        if self.counter>=80:
            ...
            self.get_current_room().draw()
            print()
            print(Fg.green + "Fame:" + Fg.rs)

            if self.counter==0:
                print("\t  [ ][ ][ ][ ][ ]  ")

            elif self.counter>0 and self.counter<=16:
                print(Fg.yellow + "\t  [*][ ][ ][ ][ ]  " + Fg.rs)

            elif self.counter>16 and self.counter<=32:
                print(Fg.yellow + "\t  [*][*][ ][ ][ ]  " + Fg.rs)

            elif self.counter>32 and self.counter<=48:
                print(Fg.lightred + "\t  [*][*][*][ ][ ]  " + Fg.rs)

            elif self.counter>48 and self.counter<=64:
                print(Fg.lightred + "\t  [*][*][*][*][ ]  " + Fg.rs)

            elif self.counter>64 and self.counter<80:
                print(Fg.red + "\t  [*][*][*][*][*]  " + Fg.rs)

            print()
            self.player.draw_inventory()
            print()
            print(Fg.red + "Azioni:" + Fg.rs)
            ...
            print()
            if self.counter>64 and self.counter<80:
